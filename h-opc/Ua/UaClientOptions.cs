...
namespace Hylasoft.Opc.Ua
{
    ...
    public class UaClientOptions
    {
        ...
        /// <summary>
        /// Specifies the ApplicationUri for the client application.
        /// </summary>
        /// <remarks>
        /// This Field is mandatory for secured connections.
        /// The ApplicationUri must be the same specified in the application certificate.
        /// </remarks>
        ...
        /// <summary>
        /// Creates a client options object for secured connection
        /// </summary>
        /// <param name="applicationCertificate">The certificate of the application</param>
        /// <param name="applicationName">The name of the application</param>
        /// <param name="applicationUri">The URI of the application</param>
        public UaClientOptions(X509Certificate2 applicationCertificate, string applicationName, Uri applicationUri) : this()
        {
            this.ApplicationCertificate = applicationCertificate;
            this.ApplicationName = applicationName;
            this.ApplicationUri = applicationUri;
            this.SessionName = applicationName;
            this.ConfigSectionName = applicationName;
        }
    }
}
